...
const (
	...
	TokenErrorParamsValidationEvaluation = "tok-params-valid-err"
...
var TokErrorTextMapping = map[string]TokErrorInfo{
	...
	TokenErrorParamsValidationEvaluation: {StatusCode: http.StatusBadRequest, Code: TokenErrorParamsValidationEvaluation, Text: "input params validation"},
